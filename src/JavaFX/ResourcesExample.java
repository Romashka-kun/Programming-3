...
/*
* Jar файлы - это аналог запускамых файлов типа exe в Windows. Они содержат внутри себя:
*   - скомплированные классы (.class файлы)
*   - ресурсы
*   - файл Манифеста. Описывает метаинформацию, например, кто автор приложения, версия приложения, может описывать
*     запускаемый класс с main методом. Может содержать ссылки на библиотеки, если эти библиотеки уже не находятся
*     сами внутри jar
* Фактически, jar файл - это zip архив, при желании его можно даже создавать вручную, архивируя содержимое.
*
* jar - java archive*/
